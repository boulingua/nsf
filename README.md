# nsf — Norwegian as a foreign language

<img src="brand/icon.png" alt="Norwegian icon" width="64" align="right">

**Norsk som fremmedspråk (NSF)** — a course in the making for the
...
Norwegian (Bokmål), with notes on Nynorsk where relevant.
